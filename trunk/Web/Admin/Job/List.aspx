<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Cms.Web.Admin.Job.List" %>
...
<body style="padding:10px;">
    ...
    <div style="height:20px;width:100%;">
       <img src="../Images/Icons/application_form.png" /><span>招聘管理 &gt;&gt; 招聘列表</span><span class="navigationAdd"><a href="Add.aspx">添加招聘</a></span>
    </div>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listtable">
      <tr>
        ...
        <th width="60%" valign="middle">岗位职称</th>
        <th width="10%" valign="middle">招聘人数</th>
      ...
      <tr>
        ...
        <asp:Label ID="lb_id" runat="server" Text='<%#Eval("JobID")%>' Visible="false"></asp:Label>
        </td>
        <td align="center"><%#Eval("Position") %></td>
        <td align="center"><%#Eval("HeadCount")%></td>
        <td align="center">
        ...
        <td align="center"><span><a href="Edit.aspx?JobID=<%#Eval("JobID") %>">修改</a></span></td>
      </tr>
      </ItemTemplate>
      <FooterTemplate>
      </table>
