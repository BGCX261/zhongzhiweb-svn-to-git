<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Cms.Web.Admin.Manage.Edit" %>
...
<body style="padding:10px;">
    ...
    <div style="height:20px;width:100%;">
       <span class="navigationBack"><a href="List.aspx">[返回列表]</a></span><img src="../Images/Icons/application_form_edit.png" /><span>用户管理 &gt;&gt; 编辑用户</span>
    </div>
    <div class="spAboveTable"></div>
           <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
              ...
              <tr>
                ...
                <td>
                <asp:TextBox ID="txtUserPwd" runat="server" CssClass="input" size="25" maxlength="50" TextMode="Password"></asp:TextBox>
                </td>
              </tr>
              <tr>
                <td class="tdLeft" align="right">确认密码：</td>
                <td>
                <asp:TextBox ID="txtUserPwd1" runat="server" CssClass="input" size="25" minLength="4" 
            maxlength="50" equalTo="#txtUserPwd" TextMode="Password"></asp:TextBox>
                </td>
              </tr>
              <tr>
