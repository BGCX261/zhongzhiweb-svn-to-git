<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Cms.Web.Admin.Solution.Edit" %>
...
<body style="padding:10px;">
    ...
    <div style="height:20px;width:100%;">
       <img src="../Images/Icons/application_form_edit.png" /><span>解决方案 &gt;&gt; 修改案例</span><span class="navigationBack"><a href="List.aspx">[返回列表]</a>
    </div>
    <div class="spAboveTable"></div>
           <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
              <tr>
                <th colspan="3" style="text-align: center;">修改解决方案</th>
              </tr>
              <tr>
                <td class="tdLeft" width="100" align="right">案例名称：</td>
                <td colspan="2">
                <asp:TextBox ID="caseTitle" runat="server" CssClass="input required" size="25" maxlength="50" minlength="3" Width="300px"></asp:TextBox>
                </td>
              </tr>
              <tr>
              ...
              <tr>
               ...
               <tr class="upordown">
                   ...
                   <td width="100">
                       <img id="solutionImg" src="../Tools/Http_ImgLoad.ashx?w=100&h=100&gurl=<%=model.ImageUrl%>" alt="<%=model.Title%>" border="1"
            ...
            <tr>
              ...
              <tr>
                <td class="tdLeft" align="right">是否锁定：</td>
                <td colspan="2">
