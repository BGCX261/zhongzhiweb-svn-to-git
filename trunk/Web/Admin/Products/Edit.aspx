<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Cms.Web.Admin.Products.Edit" %>
...
<body style="padding:10px;">
    ...
    <div style="height:20px;">
       <img src="../Images/Icons/application_form_edit.png" /><span>产品管理 &gt;&gt; 型号信息</span><span class="navigationBack"><a href="List.aspx">[返回列表]</a>
    </div>
    <div class="spAboveTable"></div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        <tr>
            <th colspan="4" style="text-align:center;">修改产品型号信息</th>
        </tr>
        <tr>
        ...
        <tr class="upordown">
            ...
            <td width="200">
                <img id="ProductImg" src="../Tools/Http_ImgLoad.ashx?w=200&h=200&gurl=<%=model.ImgUrl%>" alt="<%=model.Specifications%>" border="1"
